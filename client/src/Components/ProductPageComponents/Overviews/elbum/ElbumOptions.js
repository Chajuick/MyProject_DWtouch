// 이미지
import MainImg from "../../../../assets/products/introImgs/products_introImgs_elbum.jpg";
import SubImgGraduation from "../../../../assets/products/introImgs/products_introImgs_elbum_grad.jpg";
import SubImgFriends from "../../../../assets/products/introImgs/products_introImgs_elbum_friends.jpg";
import SubImgTeacher from "../../../../assets/products/introImgs/products_introImgs_elbum_teacher.jpg";
import SubImgFuture from "../../../../assets/products/introImgs/products_introImgs_elbum_plan .jpg";
...
export const introGuider = {
  title: "아름다운 마무리, 나만의 앨범으로 거두어보아요.",
  subTitle: "특별한 순간들을 담아두고 추억을 간직해요.",
  MainImg: MainImg, 
  typeTitle: "당신의 소중한 기억들을 평생 간직해보아요.",
  typeSubTitle: "한 번뿐인 졸업, 세상에 한 개뿐인 나만의 디자인으로 남겨보아요.",
  typeImgs: {
    typeImg1: {
      title: "졸업식의 빛나는 순간을",
      subTitle: "#졸업앨범 #기억해보자",
      img: SubImgGraduation,
    },
    typeImg2: {
      title: "함께한 친구들과의 추억을",
      subTitle: "#친구와함께 #추억살리기",
      img: SubImgFriends,
    },
    typeImg3: {
      title: "선생님과의 소중한 이별을",
      subTitle: "#선생님과함께 #감사인사",
      img: SubImgTeacher,
    },
    typeImg4: {
      title: "앞으로의 꿈과 계획을",
