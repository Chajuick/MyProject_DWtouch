...
import { optFamily, options, introGuider, detailTextGuider } from "../../../Components/ProductPageComponents/Overviews/fanbook/FanbookOptions";
...
export default function FanbookOverviewPage({ setShowLoginModal }) {
    const productId = 2;
    ...
    function ProductInfoLoading() {
        fetch(`http://192.168.0.7:3001/api/products/optinfo`, {
            method: 'POST',
            headers: {
    ...
    function ProductOptImgLoading() {
        fetch(`http://192.168.0.7:3001/api/products/opt-img-get`, {
            method: 'POST',
            headers: {
            'Content-Type': 'application/json',
            },
