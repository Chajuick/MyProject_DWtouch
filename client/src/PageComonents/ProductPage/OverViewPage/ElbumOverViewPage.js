...
import { optFamily, options, introGuider, detailTextGuider } from "../../../Components/ProductPageComponents/Overviews/elbum/ElbumOptions";
...
export default function ElbumOverviewPage({ setShowLoginModal }) {
    const productId = 3;
